...
export class UsersWordsController {
    ...
    @Get(":userId/words")
    getUserWords(@Param("userId", new ParseUUIDPipe({ version: "4" })) userId: string) {
    ...
    @Get(":userId/words/:id")
    getUserWordsById(@Param("id") id: string, @Param("userId", new ParseUUIDPipe({ version: "4" })) userId: string) {
    ...
    deleteUserWords(@Param("id") id: string, @Param("userId", new ParseUUIDPipe({ version: "4" })) userId: string) {
